...
(
    Select
        Bodegas.codigo_producto,
        count(Bodegas.codigo_producto) as cantidad
    from
        Bodegas
    group by Bodegas.codigo_producto
) as x
where
x.cantidad <'.$cantidad.'
and 
Productos.codigo_producto=x.codigo_producto;';
  ...
  <nav class="navbar navbar-dark" id="navbar">
    ...
    <div class="group">
        <div class="jumbotron jumbotron-fluid text-center" id="jumbo">
            <div class="container">
              <h1 class="display-4">Nombres de los productos con stock menores a X</h1>
            </div>
        </div>
        <div class="container">
            <div class="row">
