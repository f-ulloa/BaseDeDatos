...
$fecha=$_POST['fecha'];
$consulta = 'SELECT Vendedores.nombre, sum(Ventas.monto) as monto from Ventas,Vendedores
where Vendedores.codigo_vendedor=Ventas.codigo_vendedor
and Ventas.fecha_venta=date("'.$fecha.'")
  ...
  <nav class="navbar navbar-dark" id="navbar">
    ...
    <div class="group">
        <div class="jumbotron jumbotron-fluid text-center" id="jumbo">
            <div class="container">
              <h1 class="display-4">Lista de montos obtenidos por cada vendedor en un día “FechaAConsultar”</h1>
            </div>
        </div>
        <div class="container">
            <div class="row">
