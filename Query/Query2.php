...
ADDDATE(
    Ventas.fecha_venta,
    INTERVAL MONTH (Productos.garantia) MONTH
) AS Vencimiento_garantia
FROM
Productos,
Ventas
WHERE
'.$codigo_venta.' = Ventas.codigo_venta
and '.$codigo_producto.' = Productos.codigo_producto';
  ...
  <nav class="navbar navbar-dark" id="navbar">
    ...
    <div class="group">
        <div class="jumbotron jumbotron-fluid text-center" id="jumbo">
            <div class="container">
              <h1 class="display-4">Obtener la fecha de un vencimiento de la garantía de un producto comprado en la tienda, a partir del codigoVenta y codigoProducto </h1>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <table id="tablaventas_detalle" class="table-striped table-bordered" style="width:100%">
                        <thead class="text-center">
                            ...
                            <th>Fecha Vencimiento_garantia</th>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <tr class="text-center text-light">
                                ...
                                <td><?php echo $ojo['Vencimiento_garantia']?></td>
