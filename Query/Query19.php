...
$consulta = '
SELECT Productos.nombre, Productos.precio_venta from Productos 
    WHERE Productos.precio_venta between  '.$precio_min.' and '.$precio_max.' ;'
;
  ...
  <nav class="navbar navbar-dark" id="navbar">
    ...
    <div class="group">
        <div class="jumbotron jumbotron-fluid text-center" id="jumbo">
            <div class="container">
              <h1 class="display-4">Productos entre un rango de precio de venta, precio_min, precio_max.</h1>
            </div>
        </div>
        <div class="container">
            <div class="row">
