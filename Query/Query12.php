...
(
    Select
        Bodegas.codigo_bodega as codigo,
        sum(Bodegas.cantidad)
        as cantidad
    from
        Bodegas
    group by
        Bodegas.codigo_bodega
) as piden
where
piden.cantidad = (
    Select
  ...
  <nav class="navbar navbar-dark" id="navbar">
    ...
    <div class="group">
        <div class="jumbotron jumbotron-fluid text-center" id="jumbo">
            <div class="container">
              <h1 class="display-4">Bodega(s) la(s) cual(es) contiene la menor cantidad de productos</h1>
            </div>
        </div>
        <div class="container">
            <div class="row">
